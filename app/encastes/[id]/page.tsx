...
export default function EncastesDetailPage({ params }: PageProps) {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600">Cargando información del encaste...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      <DeleteModal
        ...
        title="Eliminar Encastes"
        description="Acción permanente e irreversible"
        itemName={`#${encaste.id.slice(0, 8).toUpperCase()}`}
        itemType="encaste"
      />
